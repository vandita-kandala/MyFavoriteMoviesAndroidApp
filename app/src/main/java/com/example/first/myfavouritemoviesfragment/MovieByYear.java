        ...
        getActivity().findViewById(R.id.imageButton).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(x < length-1) {
                    ...
                    toast = Toast.makeText(getActivity(),"No movies found after this year!",Toast.LENGTH_LONG);
                    toast.show();
                }
            }
        });
        ...
        getActivity().findViewById(R.id.imageButton5).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(x >0) {
                    ...
                    toast = Toast.makeText(getActivity(),"No movies found before this year!",Toast.LENGTH_LONG);
                    toast.show();
                }
            }
        });
